...
C
      IF(TURBO_TYP.EQ.'T') THEN   !   DEFAULTS FOR TURBINES.
           ...
           ZWEIFEL  = 0.9 ! ZWEIFEL COEFFICIENT FOR TURBINES
...
C                             VARY THE CAMBER LINE SHAPE. INCREASING EXPO MOVES THE BLADE LOADING UPSTREAM.
           QLE_ROW1(1) = 90.0 ! LEADING EDGE ANGLE TO AXIAL DIRECTION IN MERIDINAL VIEW ROW 1.
           QTE_ROW1(1) = 90.0  ! TRAILING EDGE ANGLE TO AXIAL DIRECTION IN MERIDINAL VIEW ROW 1.
           QLE_ROW2(1) = 90.0  ! LEADING EDGE ANGLE TO AXIAL DIRECTION IN MERIDINAL VIEW ROW 2.
           QTE_ROW2(1) = 90.0  ! TRAILING EDGE ANGLE TO AXIAL DIRECTION IN MERIDINAL VIEW ROW 2.
      END IF
C
      ...
      DEVN_1     = 1.0     ! DEVIATION ANGLE FROM ROW 1, DEGREES.
      DEVN_2     = 1.0     ! DEVIATION ANGLE FRON ROW 2, DEGREES.
...
C
      ...
      IM      = 27   ! NUMBER OF GRID POINTS IN THE PITCHWISE DIRECTION.
      KM      = 27   ! NUMBER OF GRID POINTS IN THE SPANWISE DIRECTION.
      NINTUP  = 10   ! NUMBER OF MERIDIONAL GRID POINTS UPSTREAM OF THE LEADING EDGE.
      NINTON  = 30   ! NUMBER OF MERIDIONAL GRID POINTS ON THE BLADE.
      NINTDWN = 8    ! NUMBER OF MERIDIONAL GRID POINTS BEHIND THE TRAILING EDGE.
      NADDUP  = 3    ! EXTRA MERIDIONAL GRID POINTS UPSTREAM OF ROW 1.
      NADDWN  = 3    ! EXTRA MERIIONAL GRID POINTS DOWNSTREAM OF THE LAST ROW.
...
C    SET THE ABSOLUTE TANGENTIAL VELOCITIES. THIS IS NOT CORRECT FOR MIXTYP = "B".
      ...
      WRITE(6,*)
      WRITE(6,*) ' Ct1     CT2     CT3    CT4'
      WRITE(6,131) VT_LE1, VT_TE1, VT_LE2, VT_TE2
  133 CONTINUE
...
C
C
      WRITE(9,1261) '*********************STARTING DATA FOR A NEW BLADE 
     &***************************'
 1261 FORMAT('',A)
      WRITE(9,126) NROW
